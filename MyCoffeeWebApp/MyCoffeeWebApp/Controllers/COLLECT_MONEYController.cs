...
namespace MyCoffeeWebApp.Controllers
{
    public class COLLECT_MONEYController : Controller
    {
        ...
        {
            var cOLLECT_MONEY = db.COLLECT_MONEY.Include(c => c.DATE).Include(c => c.MENU);
        ...
        public async Task<ActionResult> Create([Bind(Include = "CLMN_ID,DATE_ID,MN_ID,CLMN_QUANLITY,CLMN_PRICE,CLMN_NOTE")] COLLECT_MONEY cOLLECT_MONEY)
        {
            ...
            ViewBag.DATE_ID = new SelectList(db.DATEs, "DATE_ID", "date_name", cOLLECT_MONEY.DATE_ID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "CLMN_ID,DATE_ID,MN_ID,CLMN_QUANLITY,CLMN_PRICE,CLMN_NOTE")] COLLECT_MONEY cOLLECT_MONEY)
        {
            if (ModelState.IsValid)
            {
